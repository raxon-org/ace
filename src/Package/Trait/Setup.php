...
trait Setup {
    const NAME = 'Ace';
    const DISPLAY_NAME = 'Ace editor';
    const DESCRIPTION = 'Ace editor (Multiple languages)';
    const ROUTE_NAME = 'application-ace-editor';
...
//            'controller' => $object->config('controller.dir.data') . self::EXTENSION_ENABLED . $object->config('extension.json'),
        ...
        $this->install_extension_content_type($flags, $options);
